...
const SKILL_NAME = 'AverageHandleTime';
const GET_HERO_MESSAGE = "Here's Average Handle Time: ";
const HELP_MESSAGE = 'You can say please fetch me a Average Handle Time, or, you can say exit... What can I help you with?';
...
function getNewHero() {
  ...
  var welcomeSpeechOutput = 'Welcome to VA Analytics Bot<break time="0.3s" />'
  if (!isFisrtTime) {
    welcomeSpeechOutput = '';
  }
